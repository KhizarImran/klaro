...
import { TrendingUp, Wallet, Target, TrendingDown, Award, AlertTriangle } from 'lucide-react'
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        {!report ? (
          ...
          <div className="space-y-8">
            ...
            {/* Coming Soon: Charts and Trade History */}
            <div className="bg-[oklch(14%_0.01_240)] border border-[oklch(25%_0.01_240)] rounded-lg p-12 text-center">
              <h3 className="text-2xl font-bold text-white mb-2">More Analytics Coming Soon</h3>
              <p className="text-[oklch(65%_0.01_240)]">
                Equity curves, trade history table, performance charts, and more...
              </p>
            </div>
          </div>
        )}
